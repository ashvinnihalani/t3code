...
export const APP_SERVER_SSH_HOSTS_CHANNEL = "desktop:app-server-ssh-hosts";
export const APP_SERVER_WORKSPACE_OPENERS_CHANNEL = "desktop:app-server-workspace-openers";
export const APP_SERVER_WORKSPACE_OPEN_CHANNEL = "desktop:app-server-workspace-open";
