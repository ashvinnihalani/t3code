...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const userDataDirName = isDevelopment ? "t3codex-dev" : "t3codex";
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.t3tools.t3codex.dev" : "com.t3tools.t3codex",
    ),
    linuxDesktopEntryName: isDevelopment ? "t3codex-dev.desktop" : "t3codex.desktop",
    linuxWmClass: isDevelopment ? "t3codex-dev" : "t3codex",
