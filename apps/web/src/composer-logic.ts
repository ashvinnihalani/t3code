...
export type ComposerSlashCommand = "model" | "plan" | "default" | "help";
...
const SLASH_COMMANDS: readonly ComposerSlashCommand[] = ["model", "plan", "default", "help"];
...
export function parseStandaloneComposerSlashCommand(
  ...
  const match = /^\/(plan|default|help)\s*$/i.exec(text.trim());
  if (!match) {
    return null;
  }
