...
function isStateStorage(storage: unknown): storage is StateStorage {
  return (
    storage !== null &&
    typeof storage === "object" &&
    typeof (storage as StateStorage).getItem === "function" &&
    typeof (storage as StateStorage).setItem === "function" &&
    typeof (storage as StateStorage).removeItem === "function"
  );
}

const terminalStateStorage: StateStorage =
  typeof localStorage !== "undefined" && isStateStorage(localStorage)
    ? localStorage
    : createMemoryStorage();
