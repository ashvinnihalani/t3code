...
export const KiroCliIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M15.972 7.25C12.301 7.25 9.325 10.226 9.325 13.897V17.468C9.325 18.794 8.847 20.075 7.979 21.076L7.269 21.896C6.107 23.237 7.06 25.339 8.835 25.339H9.183C10.382 25.339 11.534 24.874 12.396 24.041L13.11 23.351V24.099C13.11 25.938 14.601 27.429 16.44 27.429C17.571 27.429 18.625 26.853 19.236 25.9L19.983 24.734L20.668 25.609C21.46 26.622 22.675 27.214 23.96 27.214C26.254 27.214 28.114 25.354 28.114 23.06V13.999C28.114 10.274 25.094 7.25 21.368 7.25H15.972Z"
      fill="#FFFDF7"
      stroke="#7C3AED"
      strokeLinejoin="round"
      strokeWidth="1.5"
    />
    <ellipse cx="16.772" cy="15.084" rx="1.196" ry="2.025" fill="#111111" />
    <ellipse cx="21.112" cy="15.084" rx="1.196" ry="2.025" fill="#111111" />
  </svg>
);
