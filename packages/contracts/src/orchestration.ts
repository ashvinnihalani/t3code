...
export const ProviderKind = Schema.Literals(["codex", "claudeAgent", "kiro"]);
...
export const KiroProviderStartOptions = Schema.Struct({
  binaryPath: Schema.optional(TrimmedNonEmptyString),
  remote: Schema.optional(ProjectRemoteTarget),
});
...
export const ProviderStartOptions = Schema.Struct({
  ...
  kiro: Schema.optional(KiroProviderStartOptions),
});
export type ProviderStartOptions = typeof ProviderStartOptions.Type;
export const RuntimeMode = Schema.Literals(["approval-required", "full-access"]);
export type RuntimeMode = typeof RuntimeMode.Type;
export const DEFAULT_RUNTIME_MODE: RuntimeMode = "full-access";
export const ProviderInteractionMode = Schema.Literals(["default", "plan", "help"]);
...
export const OrchestrationThread = Schema.Struct({
  ...
  branch: Schema.Array(Schema.NullOr(TrimmedNonEmptyString)),
  worktreePath: Schema.Array(Schema.NullOr(TrimmedNonEmptyString)),
...
const ThreadMetaUpdateCommand = Schema.Struct({
  ...
  branch: Schema.optional(Schema.Array(Schema.NullOr(TrimmedNonEmptyString))),
  worktreePath: Schema.optional(Schema.Array(Schema.NullOr(TrimmedNonEmptyString))),
});
...
export const ThreadTurnStartCommand = Schema.Struct({
  ...
  gitSettings: Schema.optional(GitRequestSettings),
