...
export const WS_METHODS = {
  ...
  gitRunAggregateAction: "git.runAggregateAction",
...
const WebSocketRequestBody = Schema.Union([
  ...
  tagRequestBody(WS_METHODS.gitRunAggregateAction, GitRunAggregateActionInput),
  tagRequestBody(WS_METHODS.gitListBranches, GitListBranchesInput),
  tagRequestBody(WS_METHODS.gitListRepositories, GitListRepositoriesInput),
