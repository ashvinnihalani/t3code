...
export const WS_METHODS = {
  ...
  gitProjectPull: "git.projectPull",
  gitProjectStatus: "git.projectStatus",
  gitProjectRunStackedAction: "git.projectRunStackedAction",
  gitProjectListBranches: "git.projectListBranches",
  gitProjectCreateWorktree: "git.projectCreateWorktree",
  gitProjectCreateBranch: "git.projectCreateBranch",
  gitProjectCheckout: "git.projectCheckout",
...
const WebSocketRequestBody = Schema.Union([
  ...
  tagRequestBody(WS_METHODS.gitProjectPull, GitProjectPullInput),
  tagRequestBody(WS_METHODS.gitProjectStatus, GitProjectStatusInput),
  tagRequestBody(WS_METHODS.gitProjectRunStackedAction, GitProjectRunStackedActionInput),
  tagRequestBody(WS_METHODS.gitProjectListBranches, GitProjectListBranchesInput),
  tagRequestBody(WS_METHODS.gitProjectCreateWorktree, GitProjectCreateWorktreeInput),
  tagRequestBody(WS_METHODS.gitProjectCreateBranch, GitProjectCreateBranchInput),
  tagRequestBody(WS_METHODS.gitProjectCheckout, GitProjectCheckoutInput),
